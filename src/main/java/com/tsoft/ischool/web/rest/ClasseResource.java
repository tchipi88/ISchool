...
public class ClasseResource {
     ...
     * new classe, or with status 400 (Bad Request) if the classe has already an
     * ID
     ...
     *
     * @param pageable
     * @return the ResponseEntity with status 200 (OK) and the list of classes
     * in body
     */
    @GetMapping("/classes")
    @Timed
    ...
    public ResponseEntity<List<Classe>> getAllClasses() {
        log.debug("REST request to get all Classes");
        List<Classe> page = classeRepository.findAll();
