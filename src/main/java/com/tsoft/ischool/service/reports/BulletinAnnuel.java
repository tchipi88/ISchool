...
//    @GetMapping("/bulletin-annuel/{eleve}")
//    @Timed
    public ResponseEntity<byte[]> printBulletinTri(@PathVariable Long eleve) throws Exception {
    ...
    public ResponseEntity<byte[]> printBulletinTriClasse(@PathVariable String classe) throws Exception {
        ...
        String reportfile = resourceLoader.getResource("classpath:ischool/reports/BulletinAnnuel.jasper").getFile().getAbsolutePath();
