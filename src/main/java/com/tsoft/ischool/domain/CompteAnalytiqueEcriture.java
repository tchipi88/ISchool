...
public class CompteAnalytiqueEcriture extends AbstractAuditingEntity{
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CompteAnalytiqueEcriture)) {
            return false;
        }
        CompteAnalytiqueEcriture other = (CompteAnalytiqueEcriture) object;
