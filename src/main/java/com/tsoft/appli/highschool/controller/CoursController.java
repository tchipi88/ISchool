...
public class CoursController {
     ...
     *
     * @return the ResponseEntity with status 200 (OK) and the list of Cours in
     * body
     */
    ...
    @RequestMapping(value = "/CoursByProf/{prof}", method = RequestMethod.GET)
    public ResponseEntity<List<Cours>> listCoursByProf(@PathVariable Integer prof) throws Exception {
        return new ResponseEntity<>(Coursrepository.findByAnneeAndProfesseurCode(as.getAnneeCourante(), prof), HttpStatus.OK);
    }
    @RequestMapping(value = "/CoursByClasse/{classe}", method = RequestMethod.GET)
    public ResponseEntity<List<Cours>> listCoursByClasse(@PathVariable Integer classe) throws Exception {
        return new ResponseEntity<>(Coursrepository.findByAnneeAndClasseCode(as.getAnneeCourante(), classe), HttpStatus.OK);
    }
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the Cours,
    ...
    public ResponseEntity<Cours> saveCours(@RequestBody Cours e) throws Exception {
        ...
        e.setAnnee(as.getAnneeCourante());
