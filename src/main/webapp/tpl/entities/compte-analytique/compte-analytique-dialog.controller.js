(function() {
    ...
    CompteAnalytiqueDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$uibModal','DataUtils', 'entity', 'CompteAnalytique','Eleve'];

    function CompteAnalytiqueDialogController ($timeout, $scope, $stateParams, $uibModalInstance,$uibModal, DataUtils, entity, CompteAnalytique ,Eleve) {
        var vm = this;
