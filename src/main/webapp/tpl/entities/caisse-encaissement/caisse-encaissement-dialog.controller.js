(function() {
    ...
    function CaisseEncaissementDialogController ($timeout, $scope, $stateParams, $uibModalInstance,$uibModal, DataUtils, entity, CaisseEncaissement ,Caisse) {
        ...
        function save () {
            vm.isSaving = true;
            if (vm.caisseEncaissement.id !== null) {
                CaisseEncaissement.update(vm.caisseEncaissement, onSaveSuccess, onSaveError);
            } else {
                CaisseEncaissement.save(vm.caisseEncaissement, onSaveSuccess, onSaveError);
            }
        }

        function onSaveSuccess (result) {
            $scope.$emit('tkbrApp:caisseEncaissementUpdate', result);
                ...
                if ($file) {
                    DataUtils.toBase64($file, function (base64Data) {
                        $scope.$apply(function () {
                            vm.caisseEncaissement[fieldName] = base64Data;
                            vm.caisseEncaissement[fieldName + 'ContentType'] = $file.type;
                        });
                    });
                }
            };
            ...
            vm.zoomColumn = function (lookupCtrl,lookupTemplate, fieldname, entity) {
                $uibModal.open({
                    ...
                    resolve: {
                        ...
                        vm.caisseEncaissement[fieldname] = item;
                }, function() {
